      ...
      />
            ...
            <View style={{ alignSelf: "center" }}>
                ...
                <View style={styles.dm}>
                    <MaterialIcons name="chat" size={18} color="#fff"></MaterialIcons>
                </View>
            ...
            <View style={{ marginTop: 32 }}>
                <ScrollView horizontal={true} >
                    <View style={styles.mediaImageContainer}>
                        <Image source={require("../images/media1.jpg")} style={styles.image} resizeMode="cover"></Image>
                    </View>
                    <View style={styles.mediaImageContainer}>
                        <Image source={require("../images/media2.jpg")} style={styles.image} resizeMode="cover"></Image>
                    </View>
                    <View style={styles.mediaImageContainer}>
                        <Image source={require("../images/media3.jpg")} style={styles.image} resizeMode="cover"></Image>
                    </View>
                </ScrollView>
